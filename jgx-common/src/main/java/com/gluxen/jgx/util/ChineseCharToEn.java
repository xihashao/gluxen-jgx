 ...
 * 
 * @author: (lishiqiang)
 * @e-mail: li.shi.qiang.1990@163.com
 * @date: 2017-3-15 注：只支持GB2312字符集中的汉字
 * 
 */
public class ChineseCharToEn {
	...
	public static String getFirstLetter(String chinese) {
		...
		if (chinese.length() > 1) // 判断是不是汉字
		{
			...
			} else // 非汉字字符,如图形符号或ASCII码
			{
				...
				// 欢迎大家补充说明~<span style="line-height: 1.5; font-size: 1em;">欢迎大家补充说明~</span><span style="line-height: 1.5; font-size:
				// 1em;">欢迎大家补充说明</span>
				exceptWords.put("a", "庵");
				exceptWords.put("g", "崮");
				exceptWords.put("l", "崂");
	...
	public static void main(String[] args) {
		System.out.println(ChineseCharToEn.getAllFirstLetter("遂宁市金融办"));
	}
}
